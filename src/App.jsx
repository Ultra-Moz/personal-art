  ...
  return (
    <div className="w-screen min-h-screen bg-black flex items-center justify-center">
      ...
      >
        ...
        <span className="text-yellow-300 z-50 text-2xl font-extrabold [text-stroke:1.5px_black] [-webkit-text-stroke:1.5px_black] tracking-wide absolute bottom-5 right-5">{hoverText}</span>
      </div>
    </div>
  );
};
